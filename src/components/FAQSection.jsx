...
const FAQSection = () => {
  ...
  return (
    <div className="bg-gray-100 py-16 px-6 md:px-16">
      {/* Heading */}
      <h1 className="text-center flex items-center gap-2 justify-center text-3xl md:text-4xl font-semibold text-blue-800 mb-12">
        <FaQuestionCircle />
      ...
      <div className="max-w-5xl mx-auto space-y-4">
        {faqs.map((faq, index) => (
          ...
          >
            ...
            {/* Answer */}
            {openIndex === index && (
              <div className="px-6 pb-4 text-gray-600 border-t border-t-gray-300">
                {faq.answer}
              </div>
            )}
          </div>
