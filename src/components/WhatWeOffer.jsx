      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-8">
        ...
        <div className="bg-white border p-6 rounded-xl shadow-md border-t-4 border-blue-500">
          <div className="flex items-start gap-4">
            <div className="w-12 h-12 flex items-center border border-blue-500 justify-center rounded-full bg-blue-100 shrink-0">
        ...
        <div className="bg-white border p-6 rounded-xl shadow-md border-t-4 border-green-500">
          <div className="flex items-start gap-4">
            <div className="w-12 h-12 flex items-center border border-green-500 justify-center rounded-full bg-green-100 shrink-0">
        ...
        <div className="bg-white border p-6 rounded-xl shadow-md border-t-4 border-yellow-500">
          <div className="flex items-start gap-4">
            <div className="w-12 h-12 flex items-center justify-center border border-yellow-500 rounded-full bg-yellow-100 shrink-0">
              <FaLaptopCode className="text-yellow-500 text-2xl" />
            </div>
            <div>
              <h3 className="font-semibold text-xl text-blue-900 mb-2">
                Practical Training
        ...
        <div className="bg-white border p-6 rounded-xl shadow-md border-t-4 border-purple-500">
          <div className="flex items-start gap-4">
            <div className="w-12 h-12 flex items-center border border-purple-500 justify-center rounded-full bg-purple-100 shrink-0">
        ...
        {/* Card 5 */}
        <div className="bg-white border p-6 rounded-xl shadow-md border-t-4 border-red-500">
          <div className="flex items-start gap-4">
            <div className="w-12 h-12 flex items-center border border-red-500 justify-center rounded-full bg-red-100 shrink-0">
        ...
        {/* Card 6 */}
        <div className="bg-white border p-6 rounded-xl shadow-md border-t-4 border-indigo-500">
          <div className="flex items-start gap-4">
            <div className="w-12 h-12 flex items-center border border-indigo-500 justify-center rounded-full bg-indigo-100 shrink-0">
