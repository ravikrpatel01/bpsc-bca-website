...
const VisionForStudents = () => {
  return (
    <div className="bg-gray-100 py-3 lg:py-8 px-2 lg:px-6">
      <div className="max-w-6xl mx-auto bg-white border rounded-xl shadow-md border-l-4 border-blue-600 p-2 lg:p-5">
        <h2 className="text-xl lg:text-2xl font-bold text-blue-900 mb-1 lg:mb-4">
          My Vision for Our Students
        </h2>

        <p className="text-gray-700 lg:text-xl mb-2 lg:mb-6 leading-relaxed">
        ...
        {/* Highlight Box */}
        <div className="bg-gray-50 border-l-4 border-green-500 border rounded-md p-2 lg:p-5 mb-2 lg:mb-6">
          <h3 className="font-semibold text-lg text-blue-900 mb-1 lg:mb-4">
        ...
        {/* Message */}
        <p className="text-gray-600 mb-2 lg:text-lg leading-relaxed">
        ...
        <p className="text-gray-600 lg:text-lg mb-2">
