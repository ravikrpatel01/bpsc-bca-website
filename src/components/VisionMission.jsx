    ...
    <div>
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10 items-center">
          ...
          <div>
            <img
              src="/vision.svg"
              alt="Vision"
              className="w-full h-80 object-cover rounded-2xl border-5 border-blue-600"
            />
          </div>
          ...
          <div>
            ...
            <div className="bg-white border text-lg px-5 py-3 rounded-xl shadow-md border-l-4 border-blue-600">
      ...
      <div className="bg-gray-100 pb-10 px-6">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10 items-center">
          ...
          <div>
            <div className="flex items-center gap-3 mb-3">
              <div className="bg-green-700 text-white w-12 h-12 flex items-center justify-center rounded-full">
                <FaBullseye className="text-2xl" />
              </div>
              <h2 className="text-2xl font-bold text-green-900">Our Mission</h2>
            </div>

            <div className="bg-white border px-5 py-3 rounded-xl shadow-md border-l-4 border-green-700 space-y-1">
              <p className="text-gray-700 mb-1 text-lg text-justify font-medium">
          ...
          <div className="mt-15">
            <img
              src="/mission.svg"
              alt="Mission"
              className="w-full h-90 object-cover rounded-2xl border-5 border-green-600"
            />
          </div>
        </div>
      </div>
