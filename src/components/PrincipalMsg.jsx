  ...
  return (
    <div className="bg-gray-100 py-16 px-6">
      <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-6">
        {/* Left Profile Card */}
        <div className="bg-blue-50 rounded-xl shadow-md p-6 border border-gray-400">
          <div className="w-full flex justify-center">
            <img
              src="/principal_image.jpeg"
              alt="Principal"
              className="w-45 h-45 bg-gray-200 object-center border-2 border-emerald-700 p-2 rounded-full mb-1"
            />
          </div>
          ...
          <p className="text-center text-lg text-green-800 mb-4 mt-1">
            <span className="px-1 rounded border font-medium bg-green-100">
              Principal
            </span>
          </p>

          <div className="bg-blue-50 text-lg rounded-md border border-gray-400 p-3 text-gray-700 mb-4">
          ...
          <div className="text-lg text-gray-600 space-y-2 border-t pt-3">
        ...
        {/* Right Content */}
        <div className="md:col-span-2 bg-white border rounded-xl shadow-md p-6 border-l-4 border-green-800">
