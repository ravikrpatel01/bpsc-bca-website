...
const GovernmentScholarships = () => {
  return (
    <div className="bg-gray-100 py-3 lg:py-5 px-2 lg:px-6">
      ...
      <div className="max-w-6xl mx-auto space-y-3 lg:space-y-8">
        {/* Card 1 */}
        <div className="bg-white border rounded-xl shadow-md p-2 lg:p-6 border-l-4 border-blue-500">
          ...
          <div className="grid md:grid-cols-3 gap-2 lg:gap-4">
            <div className="bg-gray-50 border border-gray-200 p-2 lg:p-3 rounded">
              <h4 className="font-semibold lg:text-lg">Eligibility:</h4>
            ...
            <div className="bg-gray-50 border border-gray-200 p-2 lg:p-3 rounded">
              <h4 className="font-semibold lg:text-lg">Benefits:</h4>
              <ul className="text-sm text-gray-600 list-disc ml-4">
            ...
            <div className="bg-gray-50 border border-gray-200 p-2 lg:p-3 rounded">
              <h4 className="font-semibold lg:text-lg">How to Apply:</h4>
              <p className="text-sm text-gray-600">
                Apply online through E-Kalyan Scholarship Portal{" "}
              </p>
              <h4 className="font-semibold lg:text-lg mt-1">Website Link:</h4>
              <p className="text-sm text-gray-600">
        ...
        {/* Card 2 */}
        <div className="bg-white border rounded-xl shadow-md p-2 lg:p-6 border-l-4 border-emerald-500">
          ...
          <div className="grid md:grid-cols-3 gap-2 lg:gap-4">
            <div className="bg-gray-50 border border-gray-200 p-1 lg:p-3 rounded">
              <h4 className="font-semibold lg:text-lg mb-1">Eligibility:</h4>
              <ul className="text-sm text-gray-600 list-disc ml-4">
            ...
            <div className="bg-gray-50 border border-gray-200 p-1 lg:p-3 rounded">
              <h4 className="font-semibold lg:text-lg mb-1">Benefits:</h4>
              <ul className="text-sm text-gray-600 list-disc ml-4">
            ...
            <div className="bg-gray-50 border border-gray-200 p-1 lg:p-3 rounded">
              <h4 className="font-semibold lg:text-lg mb-1">How to Apply:</h4>
              <p className="text-sm text-gray-600">
        ...
        <div className="bg-white border rounded-xl shadow-md p-2 lg:p-6 border-l-4 border-yellow-500">
          ...
          <p className="text-gray-600 text-sm lg:text-xl mb-1 lg:mb-4">
